...
new Vue({
    ...
    methods: {
        save: function () {
            ...
            var userConfig = mergeConfig(window.userConfig, rootMap);
...
function mergeConfig(defaultConfig, userConfig) {
    ...
    userConfig.build && (userConfig.build = Object.assign({}, build, userConfig.build));
    userConfig.output && (userConfig.output = Object.assign({}, output, userConfig.output));
