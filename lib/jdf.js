...
jdf.release = function(options, callback, type) {
    ...
    if(options.plain){
        ...
        var serverConf = {};
        serverConf.autoOpenurl = autoOpenurl;
        serverConf.comboDebug = comboDebug;
        serverConf.type = type;
        serverConf.jdfconfig = jdf.config;
        serverConf.serverDir = jdf.bgCurrentDir;
        serverConf.buildDir = jdf.getProjectPath();
