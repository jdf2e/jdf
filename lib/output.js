...
output.init = function (options) {
	...
	var outputdir = path.normalize($.pathJoin(f.currentDir(), jdf.config.outputDirName, jdf.config.projectPath));
	...
	return Promise.resolve().then(() => {
		...
		if (outputType != 'plain') {
			//return CompressScheduler.init("C:\\Users\\wangshaoxing\\Desktop\\123123\\b2","C:\\Users\\wangshaoxing\\Desktop\\123123\\b1");
		} else {
