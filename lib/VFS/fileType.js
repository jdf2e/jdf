...
fileType.extname = {
    ...
    data: ['json', 'xml', 'map', 'yml'],

    // 非文本文件类型
    font: ['ttf', 'eot', 'woff', 'cur'],
    img: ['jpg', 'png', 'gif', 'jpeg', 'ico', 'swf', 'webp', 'svg', 'mp3', 'mp4', 'flv'],
...
// 读取直接忽略的文件
fileType.ignore = {
    dir: ['test', '..', '.git', '.svn', 'node_modules', 'Thumbs', 'DS_Store', '.db', 'bower_components', '.vscode', '.idea'],
