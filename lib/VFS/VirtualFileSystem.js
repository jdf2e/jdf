...
class VFS {
    constructor() {
        ...
        this.ignoreExt = 'dll,ini,sys,exe';
        ...
        this.imgRelativeType = ['jpg', 'png', 'gif', 'jpeg'];
    }
    ...
    // 允许的文件类型
    getFilePatterns() {
        return ['*.{css,scss,less,js,es6,html,htm,vm,smarty,json,vue,ts,jpg,png,gif,jpeg}'];
    }
